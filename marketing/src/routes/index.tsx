...
function Home() {
  ...
  const tabs = [
    { title: 'Lean', url: 'https://github.com/DeepanshuMishraa/lean' },
  ...
  return (
    <div className="min-h-screen bg-white text-[#111111] font-mono antialiased selection:bg-[#111111] selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-7 pb-20">
        ...
        <div className="mt-14 rounded-2xl p-2.5 sm:p-3 bg-[#f7f7f7] border border-[#e5e5e5] shadow-[0_12px_32px_rgba(0,0,0,0.03)]">
          <div className="rounded-xl overflow-hidden bg-white border border-[#e5e5e5] flex flex-col md:flex-row min-h-[440px]">
            {/* Left Sidebar */}
            <div className="w-full md:w-60 bg-[#fafafa] border-b md:border-b-0 md:border-r border-[#ebebeb] p-3 flex flex-col justify-between select-none">
              <div className="space-y-3">
                ...
                <div className="h-8 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1 text-[#666666]">
                    <button
                      className="p-1 rounded hover:bg-[#eaeaea] text-[#111111]"
                      title="Sidebar"
                    >
                      <SidebarIcon size={13} />
                    </button>
                    <button className="p-1 rounded hover:bg-[#eaeaea] text-[#888888]">
                      <ArrowLeft size={13} />
                    </button>
                    <button className="p-1 rounded hover:bg-[#eaeaea] text-[#888888]">
                ...
                {/* Address field */}
                <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-white border border-[#e0e0e0] text-xs text-[#555555] shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
                  <MagnifyingGlass size={12} className="text-[#888888]" />
                  <span className="truncate flex-1 text-[11px] text-[#333333]">
                    {tabs[activeTab].url || 'Search or enter address...'}
                  </span>
                  {tabs[activeTab].url && (
                    <LinkIcon size={12} className="text-[#888888]" />
                  )}
                </div>
                ...
                <div className="pt-2 px-1 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-1 rounded hover:bg-[#eaeaea] text-[#666666] hover:text-[#111111]"
                    title="New Tab (⌘T)"
                  >
                  ...
                  {tabs.map((tab, idx) => (
                    <div
                      ...
                      className={`group flex items-center justify-between px-2.5 py-2 rounded-lg text-xs cursor-pointer transition-all ${
                        activeTab === idx
                          ? 'bg-[#ebebeb] text-[#111111] font-medium'
                    ...
                    >
                      ...
                      <X
                        size={11}
                        className="opacity-0 group-hover:opacity-60 hover:opacity-100 transition-opacity text-[#666666]"
                      />
                    </div>
                  ))}
                </div>
              ...
              {/* Sidebar footer */}
              <div className="pt-3 border-t border-[#ebebeb] flex items-center justify-between text-[#888888] text-xs px-1">
                <button className="hover:text-[#111111]">
            ...
            <div className="flex-1 bg-white p-6 sm:p-10 flex flex-col justify-between">
              {activeTab !== 2 ? (
                <article className="max-w-xl mx-auto space-y-5">
                  <div className="space-y-1.5">
                    <p className="text-[11px] text-[#888888] uppercase tracking-wider">
                      Essay · In Praise of Quiet Software
                    </p>
                    <h2 className="text-xl sm:text-2xl font-normal text-[#111111] leading-snug">
                      Tools that get out of the way.
                    </h2>
                  </div>

                  <div className="space-y-3.5 text-xs sm:text-sm text-[#555555] leading-relaxed">
                    <p>
                      The modern web browser has become a miniature operating
                      system full of distractions. Sidebars blinking with
                      notifications, AI assistants you never asked for, and
                      cloud synchronizations that track your every step.
                    </p>
                    <p>
                      Lean takes the opposite path. It gives your web pages room
                      to breathe within a quiet frame. When you open a tab, the
                      only thing demanding your attention is what you came to
                      read.
                    </p>
                  </div>

                  <div className="pt-2 flex items-center gap-3 text-[11px] text-[#888888]">
                    <span>Zen mode</span>
                    <span>·</span>
                    <span>Content blocking</span>
                    <span>·</span>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#111111] mb-3" />
                  <h3 className="text-xl font-medium text-[#111111]">Lean</h3>
                  <p className="mt-2 text-xs text-[#666666]">
                    Press{' '}
                    <kbd className="px-1.5 py-0.5 rounded bg-[#f0f0f0] border border-[#e0e0e0]">
                      ⌘T
                    </kbd>{' '}
                    to search or open an address
                  </p>
                </div>
              )}

              <div className="pt-4 flex items-center justify-between text-[11px] text-[#888888]">
                <span>Content blocking on</span>
                <span>Swift · WebKit</span>
              </div>
            </div>
          </div>
        </div>
