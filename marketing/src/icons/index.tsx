...
export const AppWindow: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M3 5.5A2.5 2.5 0 0 1 5.5 3h13A2.5 2.5 0 0 1 21 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 18.5v-13zM6 6.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm2.5 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm2.5 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
  </svg>
)
...
export const ArrowCircleDown: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1 6a1 1 0 1 0-2 0v5.59l-1.8-1.8a1 1 0 0 0-1.4 1.42l3.5 3.5a1 1 0 0 0 1.4 0l3.5-3.5a1 1 0 0 0-1.4-1.42L13 13.59V8z"/>
  </svg>
)
...
export const ArrowCircleRight: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-4 9a1 1 0 1 0 0 2h5.59l-1.8 1.8a1 1 0 0 0 1.42 1.4l3.5-3.5a1 1 0 0 0 0-1.4l-3.5-3.5a1 1 0 0 0-1.42 1.4l1.8 1.8H8z"/>
  </svg>
)

export const ArrowClockwise: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const ArrowCounterClockwise: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const ArrowLeft: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M10.71 4.29a1 1 0 0 0-1.42 0l-6.5 6.5a1 1 0 0 0 0 1.42l6.5 6.5a1 1 0 0 0 1.42-1.42L5.41 12H20a1 1 0 1 0 0-2H5.41l5.3-5.29a1 1 0 0 0 0-1.42z"/>
  </svg>
)
...
export const ArrowRight: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M13.29 4.29a1 1 0 0 1 1.42 0l6.5 6.5a1 1 0 0 1 0 1.42l-6.5 6.5a1 1 0 0 1-1.42-1.42L18.59 12H4a1 1 0 1 1 0-2h14.59l-5.3-5.29a1 1 0 0 1 0-1.42z"/>
  </svg>
)

export const ArrowSquareOut: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 5.5A2.5 2.5 0 0 1 6.5 3h6a1 1 0 1 1 0 2h-6A.5.5 0 0 0 6 5.5v13a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-6a1 1 0 1 1 2 0v6a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 4 18.5v-13z"/>
...
export const ArrowsCounterClockwise: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const ArrowsOutSimple: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const Bookmark: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M5 3.5A2.5 2.5 0 0 1 7.5 1h9A2.5 2.5 0 0 1 19 3.5v18a1 1 0 0 1-1.57.82L12 18.25l-5.43 4.07A1 1 0 0 1 5 21.5v-18z"/>
  </svg>
)
...
export const BookmarkSimple: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M6 3.5A2.5 2.5 0 0 1 8.5 1h7A2.5 2.5 0 0 1 18 3.5v18a1 1 0 0 1-1.58.82L12 18.27l-4.42 3.05A1 1 0 0 1 6 21.5v-18zm2.5-.5a.5.5 0 0 0-.5.5v15.74l3.42-2.36a1 1 0 0 1 1.16 0l3.42 2.36V3.5a.5.5 0 0 0-.5-.5h-7z"/>
  </svg>
)
...
export const Browser: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M5.5 3A3.5 3.5 0 0 0 2 6.5v11A3.5 3.5 0 0 0 5.5 21h13a3.5 3.5 0 0 0 3.5-3.5v-11A3.5 3.5 0 0 0 18.5 3h-13zM4 9h16v8.5a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 17.5V9zm2-2.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
  </svg>
)
...
export const ChatText: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M18.5 3H5.5A3.5 3.5 0 0 0 2 6.5v8A3.5 3.5 0 0 0 5.5 18H7v3.5a1 1 0 0 0 1.6.8L13 18h5.5a3.5 3.5 0 0 0 3.5-3.5v-8A3.5 3.5 0 0 0 18.5 3zM6 8a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1zm0 4a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1z"/>
  </svg>
)
...
export const CheckCircle: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.7 7.7a1 1 0 0 0-1.4-1.4L10.5 13.1l-1.8-1.8a1 1 0 0 0-1.4 1.4l2.5 2.5a1 1 0 0 0 1.4 0l5.5-5.5z"/>
  </svg>
)
...
export const CheckSquare: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M6 3h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3zm10.7 6.7a1 1 0 0 0-1.4-1.4L10.5 13.1l-1.8-1.8a1 1 0 0 0-1.4 1.4l2.5 2.5a1 1 0 0 0 1.4 0l5.5-5.5z"/>
  </svg>
)
...
export const CircleHalf: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 2.5a7.5 7.5 0 0 0 0 15V4.5z"/>
  </svg>
)
...
export const Clock: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1 5a1 1 0 1 0-2 0v5a1 1 0 0 0 .5.87l3.5 2a1 1 0 1 0 1-1.74L13 11.6V7z"/>
  </svg>
)

export const ClockCounterClockwise: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const Columns: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 18.5v-13zM6.5 4.5a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1H11V4.5H6.5zm6 15h4.5a1 1 0 0 0 1-1v-13a1 1 0 0 0-1-1H12.5v15z"/>
  </svg>
)
...
export const Compass: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm3.89 6.11a1 1 0 0 0-1-.27l-5.5 1.83a1 1 0 0 0-.63.63l-1.83 5.5a1 1 0 0 0 1.27 1.27l5.5-1.83a1 1 0 0 0 .63-.63l1.83-5.5a1 1 0 0 0-.27-1zM12 10.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5z"/>
  </svg>
)
...
export const Copy: React.FC<IconProps> = ({
  ...
  >
    <path d="M7.5 3A2.5 2.5 0 0 0 5 5.5v9A2.5 2.5 0 0 0 7.5 17H8v-7.5A3.5 3.5 0 0 1 11.5 6H16v-.5A2.5 2.5 0 0 0 13.5 3h-6z"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M11.5 8A2.5 2.5 0 0 0 9 10.5v8A2.5 2.5 0 0 0 11.5 21h7a2.5 2.5 0 0 0 2.5-2.5v-8A2.5 2.5 0 0 0 18.5 8h-7z"/>
  </svg>
)
...
export const Cpu: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M9 2a1 1 0 0 1 1 1v2h4V3a1 1 0 1 1 2 0v2h1.5A2.5 2.5 0 0 1 20 7.5V9h2a1 1 0 1 1 0 2h-2v2h2a1 1 0 1 1 0 2h-2v1.5a2.5 2.5 0 0 1-2.5 2.5H16v2a1 1 0 1 1-2 0v-2h-4v2a1 1 0 1 1-2 0v-2H6.5A2.5 2.5 0 0 1 4 16.5V15H2a1 1 0 1 1 0-2h2v-2H2a1 1 0 1 1 0-2h2V7.5A2.5 2.5 0 0 1 6.5 5H8V3a1 1 0 0 1 1-1zM7 7.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-9zm2 2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-5z"/>
  </svg>
)

export const DotsThree: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const Extension: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const File: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5z"/>
  </svg>
)
...
export const FileArchive: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM11 10h2v1.5h-2V10zm0 2.5h2V14h-2v-1.5zm0 2.5h2v2a1 1 0 0 1-2 0v-2z"/>
  </svg>
)
...
export const FileAudio: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM12 11a1 1 0 0 1 1 1v3.18A2.5 2.5 0 1 1 11 13V12a1 1 0 0 1 1-1z"/>
  </svg>
)
...
export const FileCsv: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM8 11h8v1.5H8V11zm0 3h8v1.5H8V14z"/>
  </svg>
)
...
export const FileImage: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM8 12.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0zm9 5.5H7l3.5-4.5 2 2.5 1.5-1.5 3 3.5z"/>
  </svg>
)
...
export const FilePdf: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM7.5 12h3a1.5 1.5 0 0 1 0 3h-2v2.5a.75.75 0 0 1-1.5 0v-5a.75.75 0 0 1 .5-.5zm1 1.5v-1.5h1.5a.5.5 0 0 1 0 1h-1.5zm5.5-1.5h2a1.5 1.5 0 0 1 1.5 1.5v2a1.5 1.5 0 0 1-1.5 1.5h-2a.75.75 0 0 1-.75-.75v-3.5a.75.75 0 0 1 .75-.75zm.75 1.5v2h1.25a.25.25 0 0 0 .25-.25v-1.5a.25.25 0 0 0-.25-.25h-1.25z"/>
  </svg>
)

export const FilePpt: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM8 11h3a2 2 0 0 1 0 4H8v3H6.5v-7H8zm0 1.5v1h3a.5.5 0 0 0 0-1H8z"/>
  </svg>
)
...
export const FileText: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM8 12a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1zm0 3.5a1 1 0 0 1 1-1h6a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1z"/>
  </svg>
)
...
export const FileVideo: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M4 4.5A2.5 2.5 0 0 1 6.5 2H14l6 6v11.5a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15zM13.5 3.5V8H18l-4.5-4.5zM10 11.5a1 1 0 0 1 1.5-.86l4 2.5a1 1 0 0 1 0 1.72l-4 2.5A1 1 0 0 1 10 16.5v-5z"/>
  </svg>
)

export const Fire: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const Folder: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M2.5 5A2.5 2.5 0 0 1 5 2.5h3.6a2.5 2.5 0 0 1 1.77.73L12 4.85h7A2.5 2.5 0 0 1 21.5 7.35v11.15a2.5 2.5 0 0 1-2.5 2.5H5a2.5 2.5 0 0 1-2.5-2.5V5z"/>
  </svg>
)
...
export const FolderPlus: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M2.5 5A2.5 2.5 0 0 1 5 2.5h3.6a2.5 2.5 0 0 1 1.77.73L12 4.85h7A2.5 2.5 0 0 1 21.5 7.35v11.15a2.5 2.5 0 0 1-2.5 2.5H5a2.5 2.5 0 0 1-2.5-2.5V5zm9.5 4a.75.75 0 0 1 .75.75V12h2.25a.75.75 0 0 1 0 1.5H12.75v2.25a.75.75 0 0 1-1.5 0V13.5H9a.75.75 0 0 1 0-1.5h2.25V9.75A.75.75 0 0 1 12 9z"/>
  </svg>
)
...
export const Layout: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M3 5.5A2.5 2.5 0 0 1 5.5 3h13A2.5 2.5 0 0 1 21 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-13A2.5 2.5 0 0 1 3 18.5v-13zM5.5 5h13a.5.5 0 0 1 .5.5V8H5V5.5a.5.5 0 0 1 .5-.5zM5 10v8.5a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5V10H5z"/>
  </svg>
)
...
export const Leaf: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M20.9 3.1c-6.8-.7-13.8 2.5-17.1 8.8-1.7 3.3-1.6 7 .6 9.2s5.9 2.3 9.2.6c6.3-3.3 9.5-10.3 8.8-17.1a1 1 0 0 0-1.5-1.5zm-8.8 15.8c-2.3 1.1-4.7.7-6.2-.8s-1.9-3.9-.8-6.2c2.4-4.8 7.6-7.8 13.1-8.1-.3 5.5-3.3 10.7-8.1 13.1z"/>
...
export const MagnifyingGlass: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M10.5 3.5a7 7 0 1 0 4.29 12.52l4.49 4.49a1.25 1.25 0 0 0 1.77-1.77l-4.49-4.49A7 7 0 0 0 10.5 3.5zm-4.5 7a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0z"/>
  </svg>
)
...
export const MinusCircle: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-4 9a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2H8z"/>
  </svg>
)
...
export const Mouse: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M6 8a6 6 0 0 1 12 0v8a6 6 0 0 1-12 0V8zm5-3a1 1 0 0 1 2 0v3a1 1 0 1 1-2 0V5z"/>
  </svg>
)
...
export const Package: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M11.5 2.2a1 1 0 0 1 1 0l8.5 4.9a1 1 0 0 1 .5.87v9.8a1 1 0 0 1-.5.87l-8.5 4.9a1 1 0 0 1-1 0l-8.5-4.9a1 1 0 0 1-.5-.87v-9.8a1 1 0 0 1 .5-.87l8.5-4.9zM12 4.47 5.03 8.5 12 12.53l6.97-4.03L12 4.47zM4 10.24v6.02l7 4.04v-6.02l-7-4.04zm9 10.06 7-4.04v-6.02l-7 4.04v6.02z"/>
  </svg>
)
...
export const PinSlash: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const PlusCircle: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1 6a1 1 0 1 0-2 0v3H8a1 1 0 1 0 0 2h3v3a1 1 0 1 0 2 0v-3h3a1 1 0 1 0 0-2h-3V8z"/>
  </svg>
)

export const RedditLogo: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
  ...
  >
    <circle cx="12" cy="14" r="8"/>
      ...
      <path d="M12 9l2-5 3.5 1" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
  </svg>
)
...
export const ShieldCheck: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2a1 1 0 0 1 .37.07l8 3.2A1 1 0 0 1 21 6.2v6.55c0 5.4-3.66 9.53-8.62 11.2a1 1 0 0 1-.76 0C6.66 22.28 3 18.15 3 12.75V6.2a1 1 0 0 1 .63-.93l8-3.2A1 1 0 0 1 12 2zm3.7 8.7a1 1 0 0 0-1.4-1.4L11 12.6l-1.3-1.3a1 1 0 0 0-1.4 1.4l2 2a1 1 0 0 0 1.4 0l4-4z"/>
  </svg>
)
...
export const Sidebar: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M5.5 3A3.5 3.5 0 0 0 2 6.5v11A3.5 3.5 0 0 0 5.5 21h13a3.5 3.5 0 0 0 3.5-3.5v-11A3.5 3.5 0 0 0 18.5 3h-13zM4 6.5C4 5.67 4.67 5 5.5 5H8v14H5.5A1.5 1.5 0 0 1 4 17.5v-11zm5.5 12.5V5h9a1.5 1.5 0 0 1 1.5 1.5v11a1.5 1.5 0 0 1-1.5 1.5h-9z"/>
  </svg>
)

export const SlackLogo: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const Sliders: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M6.5 3a1 1 0 0 1 1 1v4.1a3 3 0 0 1 0 5.8V20a1 1 0 1 1-2 0v-6.1a3 3 0 0 1 0-5.8V4a1 1 0 0 1 1-1zm-1.5 8a1.5 1.5 0 1 0 3 0 1.5 1.5 0 0 0-3 0zm11.5-8a1 1 0 0 1 1 1v10.1a3 3 0 0 1 0 5.8V20a1 1 0 1 1-2 0v-3.1a3 3 0 0 1 0-5.8V4a1 1 0 0 1 1-1zm1.5 14a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0z"/>
  </svg>
)
...
export const SlidersHorizontal: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M3 6.5a1 1 0 0 1 1-1h4.1a3 3 0 0 1 5.8 0H20a1 1 0 1 1 0 2h-6.1a3 3 0 0 1-5.8 0H4a1 1 0 0 1-1-1zm8 1.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM3 16.5a1 1 0 0 1 1-1h10.1a3 3 0 0 1 5.8 0H20a1 1 0 1 1 0 2h-.1a3 3 0 0 1-5.8 0H4a1 1 0 0 1-1-1zm14 1.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
  </svg>
)
...
export const SpeakerHigh: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const SpeakerSlash: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const Tabs: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
  ...
  >
    <path d="M4 4.5A2.5 2.5 0 0 1 6.5 2h9A2.5 2.5 0 0 1 18 4.5V6H6.5A3.5 3.5 0 0 0 3 9.5V17h-.5A2.5 2.5 0 0 1 0 14.5v-7A2.5 2.5 0 0 1 2.5 5H4v-.5z"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M6.5 7A2.5 2.5 0 0 0 4 9.5v9A2.5 2.5 0 0 0 6.5 21h12a2.5 2.5 0 0 0 2.5-2.5v-9A2.5 2.5 0 0 0 18.5 7h-12z"/>
  </svg>
)

export const TextAlignLeft: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
...
export const Trash: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M9 3a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v1h4.5a1 1 0 1 1 0 2H19l-.9 13.1A3 3 0 0 1 15.1 22H8.9a3 3 0 0 1-2.99-2.9L5 6H4.5a1 1 0 0 1 0-2H9V3zm2 1h2V4h-2V4zm-1.5 5a.8.8 0 0 1 .8.8v8.4a.8.8 0 1 1-1.6 0V9.8a.8.8 0 0 1 .8-.8zm4.5 0a.8.8 0 0 1 .8.8v8.4a.8.8 0 1 1-1.6 0V9.8a.8.8 0 0 1 .8-.8z"/>
  </svg>
)

export const Tray: React.FC<IconProps> = ({
  size = 24,
  className,
  ...props
}) => (
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M3.5 4A2.5 2.5 0 0 0 1 6.5v11A2.5 2.5 0 0 0 3.5 20h17a2.5 2.5 0 0 0 2.5-2.5v-11A2.5 2.5 0 0 0 20.5 4h-17zm17 9H16a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2H3.5v4.5a.5.5 0 0 0 .5.5h16a.5.5 0 0 0 .5-.5V13z"/>
  </svg>
)
...
export const Warning: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M10.27 3.48a2 2 0 0 1 3.46 0l8.5 15.3A2 2 0 0 1 20.49 22H3.51a2 2 0 0 1-1.74-3.22l8.5-15.3zm1.73 4.52a1 1 0 0 0-1 1v5a1 1 0 1 0 2 0V9a1 1 0 0 0-1-1zm0 9a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5z"/>
  </svg>
)
...
export const XCircle: React.FC<IconProps> = ({
  ...
  <svg
    ...
    {...props}
  >
    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm3.7 6.3a1 1 0 0 0-1.4 0L12 10.6 9.7 8.3a1 1 0 0 0-1.4 1.4l2.3 2.3-2.3 2.3a1 1 0 1 0 1.4 1.4l2.3-2.3 2.3 2.3a1 1 0 0 0 1.4-1.4L13.4 12l2.3-2.3a1 1 0 0 0 0-1.4z"/>
  </svg>
)
