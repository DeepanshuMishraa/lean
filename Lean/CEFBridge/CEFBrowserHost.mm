...
/// schedule out of player/next/browse/get_watch API responses via fetch +
/// Response.json + JSON.parse wraps, and falls back to click-skip/mute/
/// speedup/seek for anything that still enters ad mode. Guarded re-entry
/// (the injector runs on both load-start and load-end). Mirrors
/// PageScripts.youtubeAds — keep the two in sync.
std::string YouTubeAdSkipScript() {
  ...
  return "(()=>{try{if(window.__leanYtAdsEnabled===undefined)"
         ...
         "catch(e){}}}catch(e){}"
         "try{if(!JSON.parse.__leanYtWrapped&&!window.__leanYtFetchPatched){const p=JSON.parse;"
         ...
         "try{if(window.fetch&&!window.fetch.__leanYtWrapped&&!window.__leanYtFetchPatched){const f=window.fetch;"
         ...
         "});}catch(e){return r;}});};"
         "try{w.__leanYtWrapped=true;}catch(e){}"
         "window.fetch=w;try{window.__leanYtFetchPatched=true;}catch(e){}}}catch(e){}"
         ...
         "const tame=()=>{try{if(!window.__leanYtAdsEnabled)return;"
         ...
         "try{const ob=new MutationObserver(()=>{try{"
         "if(!window.__leanYtAdsEnabled)return;tame();}catch(e){}});"
         "ob.observe(document.documentElement,{childList:true,subtree:true,attributes:true,"
         "attributeFilter:['class']});window.__leanYtSkipObserver=ob;}catch(e){}"
